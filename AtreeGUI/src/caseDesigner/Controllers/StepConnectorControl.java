...
public class StepConnectorControl implements AtreeSingleStageGUIController {
	@FXML
	...
	public void initialize() {
		...
		headerlbl.setText(StepConnectorBean.getHeaderStr());
		headerImg.setImage(new Image("file:///" + AtreeFolder.getInstance().getATreeFolder() + StepConnectorBean.getImgPath()));
		okbutton.setOnAction(e -> {			
			try {
				System.out.println(conditionTxt.getText());
				writter.writeConditionToConnection(StepHierarchyMapping.getStepNameAndItsId().get(toStep.getText()), StepHierarchyMapping.getStepNameAndItsId().get(formStep.getText()), conditionTxt.getText());
