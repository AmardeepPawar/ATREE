...
public class StepHierarchyCreator15 {
...
// hierarchyCreator method should be called from outside of class to add, delete,connect steps.also to create loop
	...
	public String twoStepConnector(String sourceStep, String destinationStep )
	{
		...
		if(rowAndItsProperties.containsKey(sourceNextRowNum))
		{
			sourceNextRowProp = rowAndItsProperties.get(sourceNextRowNum);
		}
		else
		{			
			...
			rowAndItsProperties.put(sourceNextRowNum, sourceNextRowProp);			
		}
		RowProperties destRowProp = rowAndItsProperties.get(destRowNum);
     ...
     if(pathIndexOfStepAsDestination.get(destinationStep) == null)
      {
        ...
        System.out.println(destinationRowAndIndexString + " " + sourceRowAndIndexString);
